...
const StickyNote = () => {
  ...
  const tipsList = [
    "Tip: Double-click the desktop icons on the left side to navigate to sections quickly!",
    "Tip: Click on Clippy in the bottom-right corner. He is eager to assist you!",
