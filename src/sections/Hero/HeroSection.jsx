    ...
    >
      ...
      <div className="relative flex flex-col text-center max-w-screen-4xl mx-auto md:flex-row items-center md:items-end justify-around gap-30 md:text-left ">
        <div className="md:max-w-2xl">
          ...
          <h1 className="mt-2 bg-gradient-to-r from-cyan-200 via-white to-blue-200 bg-clip-text text-5xl font-bold text-transparent md:text-6xl">
            Hey, I am Pramit!
          </h1>
          <h2 className="text-3xl mt-8 bg-gradient-to-r from-teal-300 to-cyan-300 bg-clip-text text-transparent font-semibold">
